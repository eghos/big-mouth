...
//install mocha (good test runner for javascript) and chai using npm.
// also install aws cred because the aws library used to  sign the requests internally does
//not work with aws profiles 